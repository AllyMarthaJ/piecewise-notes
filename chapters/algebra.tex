\chapter{Algebra on Piecewise Objects}
\section{Piece association}
...
\section{Piece and condition equivalence}
...
\begin{example}
    Let us consider the function from Example $\autoref{example:equality_1}$.
...
\begin{theorem}
    ...
    This is a semi-obvious fact, but becomes useful when coupled with the grouping/nesting of piecewise objects via their piece's conditions. This was also touched on in \autoref{section:notation}.
\end{theorem}

\begin{theorem}
    \label{theorem:algebra_and_values}
    We generalise \autoref{example:algebra_and} to piecewise objects. Given the following piecewise object(s):
...
\begin{theorem}
    ...
    As with \autoref{theorem:algebra_and_values}, we have a similar property on conditions rather than piece values.
