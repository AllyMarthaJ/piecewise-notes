...
Essentially all piecewise functions we work with in these notes (to a point) are able to be written in terms of Iverson brackets. In tern, certain Iverson brackets can be written in terms of elementary functions or functions we've already seen.
\begin{theorem}
