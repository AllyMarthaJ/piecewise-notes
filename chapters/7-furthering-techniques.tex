...
\begin{example}
    ...
    For the purposes of most of the working here, we \textit{minimally} interpolate (namely we don't consider more general solutions unless explicitly stated, though this will be explored).
\end{example}
...
$$
    f(x) = \sum_{m=0}^{n}{y_m\prod_{l=0}^{n}{\frac{x-x_l}{x_m-x_l}}}
$$
