...
\begin{theorem}
    ...
    $$
        \phi=\pwobj{\phi_i}{A_i\land B_i}{i\in I}
    $$
...
\begin{theorem}
    ...
    $$
        \phi=\pwobj{\phi_i}{A_i\lor B_i}{i\in I}
    $$

    For some conditions $A_i$, $B_i$, we can rewrite this as the following:

    $$
        \phi=\pwobj{\phi_i}{A_i}{i\in I}\cup\pwobj{\phi_i}{B_i}{i\in I}
    $$
...
\begin{theorem}
    ...
    $$
        \phi=\pwobj{\phi_i}{C_i}{i\in I}\cup\pwobj{\phi_j}{C_j}{j\in J}
    $$
...
\begin{theorem}
    ...
    $$
        f(\phi) = \pwobj{f(\phi_i)}{C_i}{i\in I}
    $$
    
    A quick intuition/proof is as follows: For all $i\in I$ suppose that at least one $C_i$ is true. Then we have that $\phi=\phi_i\implies f(\phi)=f(\phi_i)$. By definition that means $f(\phi)$ is as above.
\end{theorem}
